...
```
Agent(
  prompt="Read /home/user/Landing-MAGA/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/Landing-MAGA/.claude/gsd-core/templates/VALIDATION.md`
