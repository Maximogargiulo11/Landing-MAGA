...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/Landing-MAGA/.claude
                  → checks /home/user/Landing-MAGA/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/Landing-MAGA/.claude/gsd-core
                  → writes to /home/user/Landing-MAGA/.claude/gsd-core/hooks/
