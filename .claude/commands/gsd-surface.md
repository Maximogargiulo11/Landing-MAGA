...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/Landing-MAGA/.claude/.gsd-surface.json`
(sibling to `/home/user/Landing-MAGA/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/Landing-MAGA/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/Landing-MAGA/.claude/skills`).
...
`/home/user/Landing-MAGA/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/Landing-MAGA/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/Landing-MAGA/.claude/.gsd-surface.json`
Install profile marker: `/home/user/Landing-MAGA/.claude/.gsd-profile`
Skill dirs: `/home/user/Landing-MAGA/.claude/skills/gsd-*/`
Engine module: `/home/user/Landing-MAGA/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/Landing-MAGA/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
