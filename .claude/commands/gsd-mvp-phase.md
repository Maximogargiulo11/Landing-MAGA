...
<execution_context>
@/home/user/Landing-MAGA/.claude/gsd-core/workflows/mvp-phase.md
...
<process>
Execute the mvp-phase workflow from @/home/user/Landing-MAGA/.claude/gsd-core/workflows/mvp-phase.md end-to-end.
