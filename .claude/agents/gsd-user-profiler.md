...
<reference>
@/home/user/Landing-MAGA/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/Landing-MAGA/.claude/gsd-core/references/user-profiling.md` to load:
