...
Reference full template: `/home/user/Landing-MAGA/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/Landing-MAGA/.claude/gsd-core/templates/state.md`.
